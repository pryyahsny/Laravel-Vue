...
<script>
  export default {
    ...
    data() {
      return {
        // untuk menghilangkan button login saat berhasil melakukan authentication
        loggedIn: null
      }
    },
    ...
    // untuk mendapatkan nilai terbaru saat ada perubahaan secara reactive yang terjadi saat state atau properti loggedin di ubah
